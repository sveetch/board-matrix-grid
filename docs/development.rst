...
board-matrix-grid is developed with:
...
type: ::
    ...
    git clone https://github.com/sveetch/board-matrix-grid.git
    cd board-matrix-grid
    make install

board-matrix-grid will be installed in editable mode from the
